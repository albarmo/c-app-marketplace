    ...
    return (
        <div className='flex min-max w-lvw flex-col items-center justify-between space-y-5 bg-gray-50'>
            <section className="flex flex-col justify-center items-center w-full h-min p-10">
                ...
                <Image src='/images/assets/yellow-cart.webp' alt="Localoka Yello Cart" width={230} height={230} className={`${loaded ? "grayscale" : "grayscale-0"} transition-all transform-gpu delay-300 duration-1000`} />
            </section>
            <div className="p-5 h-full flex flex-col justify-between">
                ...
                <button onClick={() => router.back()} className='bg-primary self-end text-white p-3.5 font-semibold w-full mt-5 rounded-lg'>
                    Kembali
                </button>
            </div>
        </div>
